...
<!-- Reference Element -->
<div {...contentProps} bind:this={floating.elements.reference} {...interactions.getReferenceProps()}>
    {@render children?.()}
</div>
<!-- Floating Element -->
{#if open && !disabled}
    <div
        ...
        {@render content?.()}
        <FloatingArrow bind:ref={elemArrow} context={floating.context} fill="#EDE6DF" className="fill-bg-secondary" />
    </div>
{/if}
